#!/usr/bin/env python3
"""
Train Translation model with ALL available data combined (auto-start version)
"""
import torch
...
def plot_training_history(history):
    ...
    ax1.set_title('Translation Model - Loss (Fixed)', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Translation Model - Accuracy (No PAD)', fontsize=13, fontweight='bold')
    ax2.legend(fontsize=11)
    ax2.grid(True, alpha=0.3)
    
    plt.tight_layout()
    
    output_path = Path('outputs/translation_training_fixed.png')
...
def main():
    print("\n" + "="*70)
    print("TRAIN TRANSLATION MODEL - FIXED VERSION")
    print("="*70)
    print("\nFixes applied:")
    print("  ✓ Accuracy excludes PAD tokens")
    print("  ✓ Data shuffled before split")
    print("  ✓ Shared vocabularies across splits")
    print("  ✓ Lower learning rate (3e-4)")
    ...
    print(f"  - Device: {device}")
    print("  - Learning rate: 3e-4 (lower for stability)")
