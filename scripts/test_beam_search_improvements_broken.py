...
def main():
    ...
    print("="*80)
    print(f"\nBest strategy: Beam + 3-gram LM")
    print(f"  WER: {results.get('beam_3gram', {}).get('wer', 'N/A'):.2f}%")
    print(f"  Improvement: {((results['greedy']['wer'] - results.get('beam_3gram', {}).get('wer', results['greedy']['wer'])) / results['greedy']['wer'] * 100):.1f}% better than greedy")
