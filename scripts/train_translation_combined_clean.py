#!/usr/bin/env python3
"""
Train with combined clean dataset (curriculum + Google translations)
"""
import torch
...
def train_model(device, train_data, val_data, num_epochs=50, batch_size=32):
    print("\n" + "="*70)
    print("TRAINING COMBINED CLEAN MODEL")
    print("="*70)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save({
                ...
                'val_acc': val_acc
            }, checkpoint_dir / 'translation_model_combined_best.pt')
...
def main():
    print("="*70)
    print("TRAIN COMBINED CLEAN TRANSLATION MODEL")
    print("="*70)
    ...
    data_path = Path('data/translation_data/konkani_english_combined_clean.json')
    ...
    # Train
    train_model(device, train_data, val_data, num_epochs=50, batch_size=32)
    
    print("\n" + "="*70)
    print("Test with:")
    print("  python scripts/test_translation_model.py --checkpoint checkpoints/translation_model/translation_model_combined_best.pt")
    print("="*70)
